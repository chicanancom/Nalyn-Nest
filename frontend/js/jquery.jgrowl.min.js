!(function (i) {
  ...
  (a.jGrowl = function (e, t) {
    0 === a("#jGrowl").length &&
      a('<div id="jGrowl"></div>')
        .addClass(t && t.position ? t.position : a.jGrowl.defaults.position)
        .appendTo(t && t.appendTo ? t.appendTo : a.jGrowl.defaults.appendTo),
      a("#jGrowl").jGrowl(e, t);
  }),
    (a.fn.jGrowl = function (e, t) {
      if (
        (void 0 === t && a.isPlainObject(e) && (e = (t = e).message),
    ...
    a.extend(a.fn.jGrowl.prototype, {
      ...
      create: function (e, t) {
        ...
        void 0 !== i.speed &&
          ...
          this.notifications.push({ message: e, options: i }),
      ...
      render: function (e) {
        ...
        a(o)
          ...
          .bind("jGrowl.beforeOpen", function () {
            !1 !== n.beforeOpen.apply(o, [o, i, n, t.element]) &&
              a(this).trigger("jGrowl.open");
          })
          .bind("jGrowl.open", function () {
            !1 !== n.open.apply(o, [o, i, n, t.element]) &&
              ("after" == n.glue
                ? a(".jGrowl-notification:last", t.element).after(o)
                : a(".jGrowl-notification:first", t.element).before(o),
              a(this).animate(
                n.animateOpen,
                n.openDuration,
                n.easing,
          ...
          .bind("jGrowl.beforeClose", function () {
            !1 !== n.beforeClose.apply(o, [o, i, n, t.element]) &&
          ...
          .bind("jGrowl.close", function () {
            a(this).data("jGrowl.pause", !0),
              a(this).animate(
                ...
                n.easing,
                function () {
                  a.isFunction(n.close)
                    ? !1 !== n.close.apply(o, [o, i, n, t.element]) &&
                      a(this).remove()
                    : a(this).remove();
                }
              );
            ...
            a(this.defaults.closerTemplate)
              ...
              .bind("click.jGrowl", function () {
                a(this).siblings().trigger("jGrowl.beforeClose"),
                  a.isFunction(t.defaults.closer) &&
                    t.defaults.closer.apply(a(this).parent()[0], [
                      a(this).parent()[0],
                    ]);
              });
      },
